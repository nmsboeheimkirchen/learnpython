(() => {
    ...
    frame.addEventListener("load", () => {
        try {
            ...
            if (hash && !/^(verify|reset|teacher-invite)=/.test(hash)) target.hash = hash;
    ...
    if (/^#(?:verify|reset|teacher-invite)=/.test(location.hash)) history.replaceState(null,"",location.pathname+location.search);
})();
